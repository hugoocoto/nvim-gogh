...
function M.setup()
    local groups = {
        ...
        DiffAdd                          = { fg = palette.fg, bg = palette.green },     -- Diff mode: Added line. |diff.txt|
        DiffChange                       = { fg = palette.fg, bg = palette.yellow },    -- Diff mode: Changed line. |diff.txt|
        DiffDelete                       = { fg = palette.fg, bg = palette.red },       -- Diff mode: Deleted line. |diff.txt|
        DiffText                         = { fg = palette.fg, bg = palette.orange },    -- Diff mode: Changed text within a changed line. |diff.txt|
